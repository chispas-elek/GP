 ...
 * @author will
 */
public class InterfazBannerAnadirTrineo extends javax.swing.JFrame {

    /**
     * Creates new form InterfazBannerAnadirTrineo
     */
    public InterfazBannerAnadirTrineo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("TRINEO AÑADIDO.")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazBannerAnadirTrineo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
