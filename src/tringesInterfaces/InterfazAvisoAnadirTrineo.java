 ...
 * @author will
 */
public class InterfazAvisoAnadirTrineo extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAvisoAnadirTrineo
     */
    public InterfazAvisoAnadirTrineo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("¿SEGURO QUE DESEA AÑADIR EL TRINEO?")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazAvisoAnadirTrineo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAvisoAnadirTrineo().setVisible(true);
            }
        });
    }
