 ...
 * @author will
 */
public class InterfazBannerAnadirCarrera extends javax.swing.JFrame {

    /**
     * Creates new form InterfazBannerAnadirCarrera
     */
    public InterfazBannerAnadirCarrera() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("CARRERA AÑADIDA.")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazBannerAnadirCarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
