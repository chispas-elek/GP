 ...
 * @author will
 */
public class InterfazAvisoModificarCarrera extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAvisoModificarCarrera
     */
    public InterfazAvisoModificarCarrera() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("¿SEGURO QUE DESEA MODIFICAR ESTA CARRERA?")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazAvisoModificarCarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAvisoModificarCarrera().setVisible(true);
            }
        });
    }
