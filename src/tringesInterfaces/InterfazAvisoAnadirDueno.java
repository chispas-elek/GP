 ...
 * @author Aaron
 */
public class InterfazAvisoAnadirDueno extends javax.swing.JFrame {

    /**
     * Creates new form AvisoQuiereAnadirLosDatosALaBDDueno
     */
    public InterfazAvisoAnadirDueno() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazAvisoAnadirDueno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAvisoAnadirDueno().setVisible(true);
            }
        });
    }
