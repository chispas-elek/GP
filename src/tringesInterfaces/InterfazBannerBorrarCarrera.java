 ...
 * @author will
 */
public class InterfazBannerBorrarCarrera extends javax.swing.JFrame {

    /**
     * Creates new form InterfazBannerBorrarCarrera
     */
    public InterfazBannerBorrarCarrera() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("CARRERA BORRADA.")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazBannerBorrarCarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
