 ...
 * @author Aaron
 */
public class InterfazAnadirPerrosACarrera extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAnadirPerrosACarrera
     */
    public InterfazAnadirPerrosACarrera() {
        initComponents();
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        InterfazAnadirPerrosACarrera.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazAnadirPerrosACarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
