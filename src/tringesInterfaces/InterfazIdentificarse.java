...
public class InterfazIdentificarse extends javax.swing.JFrame {
    ...
    String idioma = "tringesInterfaces/Idioma";
    
    public InterfazIdentificarse(String idioma) {
    ...
    private void myInitComponents(String idioma) {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle(idioma); // NOI18N
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
       ...
       /* String user = this.tUsuario.getText();
        ...
        this.dispose();
        new InterfazUsuarioAdministrador(idioma).setVisible(true);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex()==0){
            idioma = "tringesInterfaces/Idioma_Castellano";
            this.dispose();
            new InterfazIdentificarse(idioma).setVisible(true);
        }
        else{
            idioma = "tringesInterfaces/Idioma_euskera";
            this.dispose();
            new InterfazIdentificarse(idioma).setVisible(true);
        }
